  ...
  <div class="page">
    ...
    <section>
      <article class="bright">
          <form action="../scripts/completeordenhandler.php" method="post">
            <div class="paper-holder">
              <div class="paper white">
                ...
                <?php
                  ...
                  echo('<p>ID: <input type="text" name="orderid" value="'.$_GET['orderid'].'"></p>');
                ...
                <select name="delivery">
                  <?php
                    ...
                    $query = "SELECT `idDelivery`, `nombres` FROM `delivery`";
                    ...
                    foreach($delivery as $row) {
                      echo "<option value=\"".$row['idDelivery']."\">".$row['nombres']."</option>";
                    }
                  ?>
                </select>
                <br>
