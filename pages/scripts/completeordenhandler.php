...
$query = "INSERT INTO `facturas` (`fecha`, `total`, `direccion`, `idUsuario`, `idOrden`, `idModoPago`, `idSucursal`) 
VALUES ('".$data['fecha']."', '".$data['total']."', '".$data['direccion']."', '".$data['idUsuario']."', '$orderid' , '".$data['formaDePago']."', '".$data['idSucursal']."')";
$result = mysqli_query($connection, $query);
